<?php
$titulo = 'Inscripciones - Gestión Escolar';
    ...
    <main class="main-content">
        ...
        <div class="d-flex flex-wrap justify-content-between align-items-center gap-3 mb-4">
            <div class="d-flex flex-wrap gap-2">
                ...
                <a href="index.php?action=exportar_inscripciones_pdf" class="btn btn-danger">
                    <i class="bi bi-file-pdf"></i> PDF
                </a>
                <a href="index.php?action=exportar_inscripciones_excel" class="btn btn-success">
        ...
        <?php if (empty($inscripciones)): ?>
            <div class="text-center py-5 text-muted">
                ...
                <p class="mt-3">No hay inscripciones registradas aún.</p>
            </div>
        <?php else: ?>
                ...
                <table class="table-custom">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="index.php?action=inscripcion_editar&id=<?= $i['id'] ?>" class="btn btn-warning btn-sm">
                                    <i class="bi bi-pencil"></i>
                                </a>
                                <a href="index.php?action=inscripcion_eliminar&id=<?= $i['id'] ?>" class="btn btn-danger btn-sm" onclick="return confirm('¿Eliminar esta inscripción?')">
