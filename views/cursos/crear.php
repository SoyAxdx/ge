<?php
$titulo = 'Nuevo Curso - Gestión Escolar';
        ...
        <div class="card p-4">
            <form method="POST" action="index.php?action=curso_guardar">
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" id="codigo" name="codigo" class="form-control" placeholder="Ej: DS-101" required>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="number" id="creditos" name="creditos" class="form-control" min="1" max="6" value="3" required>
                        </div>
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <input type="text" id="nombre" name="nombre" class="form-control" placeholder="Ej: Desarrollo de Software VII" required>
                </div>

                <div class="form-group">
                    <label for="descripcion">Descripción:</label>
                    <textarea id="descripcion" name="descripcion" class="form-control" rows="3" placeholder="Descripción del curso..."></textarea>
                </div>
