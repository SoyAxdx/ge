<?php
$titulo = 'Nuevo Estudiante - Gestión Escolar';
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" id="cedula" name="cedula" class="form-control" placeholder="Ej: 8-888-8888" required>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" id="telefono" name="telefono" class="form-control" placeholder="Ej: 1234-5678">
